 ...
 * @param ShortcodeOptions $options UI control options
 */
...
function display_pagination_options($options = null) {
	...
	else if(!get_pagination_state($options))
